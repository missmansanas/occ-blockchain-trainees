...
contract TokenSale is ERC20 {
  ...
  // sets the presale started to true
  // automatically sets the presale end time 
  ...
  // address calling the function should be whitelisted
  // address calling should have not yet availed the presale
  ...
  function withdraw () public onlyOwner {
    ...
    // the transaction returns a boolean (true/false) named "sent"
    require(sent == true, "Failed to withdraw balance.");
  }
}